              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex-shrink-0">
                    ...
                    <p className="text-slate-900 font-bold text-lg sm:text-xl flex items-center">
                      <span className="font-sans font-normal text-[0.85em] mr-0.5">₹</span>
                      <span>{dest.price.replace('₹', '')}</span>
                    </p>
                  </div>
                  <button
