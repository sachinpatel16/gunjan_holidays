      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {submitted ? (
          <div className="bg-white/20 rounded-2xl px-8 py-6 inline-block">
            ...
            <p className="text-blue-100 text-sm mt-1">We'll send you the best deals straight to your inbox.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto">
            <input
              ...
              required
              className="flex-1 px-5 py-4 rounded-full bg-white text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm"
            />
            <button
              type="submit"
